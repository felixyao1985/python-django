...
var swfobject = function() {
    ...
    aI = true,
    ah = function() {
        var a = typeof aL.getElementById != r && typeof aL.getElementsByTagName != r && typeof aL.createElement != r,
        ...
        f = [0, 0, 0],
        k = null;
        if (typeof aB.plugins != r && typeof aB.plugins[ab] == aD) {
            k = aB.plugins[ab].description;
            if (k && !(typeof aB.mimeTypes != r && aB.mimeTypes[aE] && !aB.mimeTypes[aE].enabledPlugin)) {
                aa = true;
                d = false;
    ...
    aK = function() {
        ...
        if ((typeof aL.readyState != r && aL.readyState == "complete") || (typeof aL.readyState == r && (aL.getElementsByTagName("body")[0] || aL.body))) {
            aP()
        }
        if (!ak) {
            if (typeof aL.addEventListener != r) {
    ...
    function aC(a) {
        if (typeof af.addEventListener != r) {
            af.addEventListener("load", a, false)
        } else {
            if (typeof aL.addEventListener != r) {
                aL.addEventListener("load", a, false)
            } else {
                if (typeof af.attachEvent != r) {
                    aM(af, "onload", a)
                } else {
    ...
    function ae(f, d, h, e) {
        ...
        if (a) {
            ...
            f.id = ac;
            if (typeof f.width == r || (!/%$/.test(f.width) && parseInt(f.width, 10) < 310)) {
                f.width = "310"
            }
            if (typeof f.height == r || (!/%$/.test(f.height) && parseInt(f.height, 10) < 137)) {
                f.height = "137"
            }
    ...
    function az(b, f, a, c) {
        ...
        if (!aH || an != g) {
            ...
            aH = e.appendChild(d);
            if (ah.ie && ah.win && typeof aL.styleSheets != r && aL.styleSheets.length > 0) {
        ...
        if (ah.ie && ah.win) {
            ...
            if (aH && typeof aL.createTextNode != r) {
    ...
    function ai(b) {
        var a = /[\\\"<>\.;]/;
        var c = a.exec(b) != null;
        return c && typeof encodeURIComponent != r ? encodeURIComponent(b) : b
    }
    var s = function() {
        if (ah.ie && ah.win) {
...
SWFUpload.prototype.callFlash = function(a, b) {
    b = b || [];
    var c = this.getMovieElement();
    var d, returnString;
    try {
        returnString = c.CallFunction('<invoke name="' + a + '" returntype="javascript">' + __flash__argumentsToXML(b, 0) + "</invoke>");
        d = eval(returnString)
    } catch(ex) {
        throw "Call to " + a + " failed";
    }
    if (d != undefined && typeof d.post === "object") {
        ...
        onSelect: function(h) {
            ...
            for (var g in this.queueData.files) {
                ...
                if (f.uploaded != true && f.name == h.name) {
					/*
                    var e = confirm('该文件 "' + h.name + '" 已经上传。\您想在重复上传该项目吗?');
                    if (!e) {
