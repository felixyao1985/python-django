...
Kalendae.prototype = {
	defaults : {
		...
		dayclick              :null,            /* array of dates, or function to be passed a date */
...
Kalendae.Input.prototype = util.merge(Kalendae.prototype, {
	...
	show : function (obj,range_type) {
		var $container = this.container,
			style = $container.style,
			$input = obj ? obj : this.input,
		...
		style.display = '';
		this.settings.range_type = range_type ? range_type : null;
		this.draw();
		switch (opts.side) {
			case 'left':
